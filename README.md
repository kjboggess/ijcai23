...
<b>Set up:</b><br>
 1. Download Shared Experience Actor Critic for MARL and install as instructed<br>
	&emsp;*Used for training and evaluation policiesv
	&emsp;Location: https://github.com/semitable/seac<br>
	&emsp;Rename "seac-master" folder to "seac"<br>
 2. Download Level-based Foraging Environment and install as instructed<br>
	&emsp;*Used to register search and rescue and level-based foraging environments to gym<br>
	&emsp;Location: https://github.com/uoe-agents/lb-foraging<br>
 3. Download further domains if preferred and install as instructed<br>
	&emsp;Robotic warehouse domain location: https://github.com/uoe-agents/robotic-warehouse<br>
	&emsp;Pressure plate location: https://github.com/semitable/pressureplate<br>
 4. Download "Improving Robot Controller Transparency Through Autonomous Policy Explanation" Implemenation and install as instructed<br>
	&emsp;*Used to set up Quine-Mccluskey algorithm<br>
	&emsp;Location: https://gitlab.tue.nl/ha800-hri/hayes-shah<br>
...
<b>Training a policy:</b>
 1. Polices should be trained as described by Shared Experience Actor Critic for MARL<br>
	&emsp;Location: https://github.com/semitable/seac
...
<b>Generating an explanation with guided rollout:</b>
 ...
 8. Run file -> "python policyConRoll3agABATotalQ.py"<br>
	&emsp;*Generates abstract mmdp through guided rollout and explanation for any impossible tasks<br>
