...
class ForagingEnv(Env):
    ...
    def spawn_food(self, max_food, max_level,currentStart):
        ...
        #self.field[2,0] = 2 #edit #Apple
        #self.field[3,5] = 2 #edit #Apple
        #self.field[4,1] = 2 #edit #Apple
    ...
    def step(self, actions):
        ...
        while loading_players:
            ...
            #3 Apples
            if(frow == 2 and fcol == 0) or (frow == 3 and fcol == 5) or (frow == 4 and fcol == 1): #Apple -> Any two agents
                if(len(adj_player_numbers))> 2:
                    continue

            # else the food was loaded and each player scores points
            for a in adj_players:
                #3 Apples
                if(frow == 2 and fcol == 0) or (frow == 3 and fcol == 5) or (frow == 4 and fcol == 1):
                    a.reward = 10
