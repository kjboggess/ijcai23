...
def createPrismModel(numberOfAgents,numberOfTasks,transitions,startState):
    ...
    features = ["apple2_comp", "apple3_comp", "apple1_comp"]
...
def buildstate(state,features,transitions,numberOfAgents):
    ...
    if numberOfAgents == 3:
        if "True" in splitstate[0]:
            parentString = parentString + "(apple2_comp_ag1 = 1) & "
        else:
            parentString = parentString + "(apple2_comp_ag1 = 0) & "
        if "True" in splitstate[1]:
            parentString = parentString + "(apple3_comp_ag1 = 1) & "
        else:
            parentString = parentString + "(apple3_comp_ag1 = 0) & "
        if "True" in splitstate[2]:
            parentString = parentString + "(apple1_comp_ag1 = 1) & "
        else:
            parentString = parentString + "(apple1_comp_ag1 = 0) & "

        if "True" in splitstate[3]:
            parentString = parentString + "(apple2_comp_ag2 = 1) & "
        else:
            parentString = parentString + "(apple2_comp_ag2 = 0) & "
        if "True" in splitstate[4]:
            parentString = parentString + "(apple3_comp_ag2 = 1) & "
        else:
            parentString = parentString + "(apple3_comp_ag2 = 0) & "
        if "True" in splitstate[5]:
            parentString = parentString + "(apple1_comp_ag2 = 1) & "
        else:
            parentString = parentString + "(apple1_comp_ag2 = 0) & "

        if "True" in splitstate[6]:
            parentString = parentString + "(apple2_comp_ag3 = 1) & "
        else:
            parentString = parentString + "(apple2_comp_ag3 = 0) & "
        if "True" in splitstate[7]:
            parentString = parentString + "(apple3_comp_ag3 = 1) & "
        else:
            parentString = parentString + "(apple3_comp_ag3 = 0) & "
        if "True" in splitstate[8]:
            parentString = parentString + "(apple1_comp_ag3 = 1) & "
        else:
            parentString = parentString + "(apple1_comp_ag3 = 0) & "
        ...
        for i in transitions[state]:
            ...
            if "True" in childstate[0]:
                childString = childString + "(apple2_comp_ag1' = 1) & "
            else:
                childString = childString + "(apple2_comp_ag1' = 0) & "
            if "True" in childstate[1]:
                childString = childString + "(apple3_comp_ag1' = 1) & "
            else:
                childString = childString + "(apple3_comp_ag1' = 0) & "
            if "True" in childstate[2]:
                childString = childString + "(apple1_comp_ag1' = 1) & "
            else:
                childString = childString + "(apple1_comp_ag1' = 0) & "

            if "True" in childstate[3]:
                childString = childString + "(apple2_comp_ag2' = 1) & "
            else:
                childString = childString + "(apple2_comp_ag2' = 0) & "
            if "True" in childstate[4]:
                childString = childString + "(apple3_comp_ag2' = 1) & "
            else:
                childString = childString + "(apple3_comp_ag2' = 0) & "
            if "True" in childstate[5]:
                childString = childString + "(apple1_comp_ag2' = 1) & "
            else:
                childString = childString + "(apple1_comp_ag2' = 0) & "

            if "True" in childstate[6]:
                childString = childString + "(apple2_comp_ag3' = 1) & "
            else:
                childString = childString + "(apple2_comp_ag3' = 0) & "
            if "True" in childstate[7]:
                childString = childString + "(apple3_comp_ag3' = 1) & "
            else:
                childString = childString + "(apple3_comp_ag3' = 0) & "
            if "True" in childstate[8]:
                childString = childString + "(apple1_comp_ag3' = 1) & "
            else:
                childString = childString + "(apple1_comp_ag3' = 0) & "
